...
| AppUpload | `apps/appupload/` | Handwritten merchant applications → typed PDFs — runs fully in the browser inside the dashboard: 12 fillable forms, packet builder, signature pad, rep picker and on-device history |
